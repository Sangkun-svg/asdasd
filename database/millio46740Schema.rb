...
ActiveRecord::Schema[8.0].define(version: 2025_01_01_000000) do
  ...
  create_table "IndexpageVideo", force: :cascade do |t|
    t.text       "description"
    t.integer    "index"
    t.string     "link"
    t.string     "title"
  ...
  create_table "Order", force: :cascade do |t|
    ...
    t.text       "fk_paymentaddionaltransaction_list_custom_additional_harge", array: true, default: []
  ...
  create_table "Paymentmain", force: :cascade do |t|
    t.decimal    "amount1"
    t.text       "description"
    t.text       "fk_addtionalpayment_list_custom_additional_harge", array: true, default: []
  ...
  create_table "Scheduleday", force: :cascade do |t|
    ...
    t.datetime   "date"
    t.integer    "day"
    t.text       "fk_scheduleactivity_list_custom_schedule_activity", array: true, default: []
    t.string     "location"
    t.integer    "programindex"
    t.datetime   "created date"
    t.datetime   "modified date"
  ...
  create_table "Scheduleprogram", force: :cascade do |t|
    t.text       "content"
    t.string     "duration"
    t.text       "fk_scedule_day_list_custom_scheduledetail", array: true, default: []
    t.integer    "index"
    t.string     "locations"
    t.decimal    "price"
  ...
  add_foreign_key "Paymentaddtional", "User", column: "created by"
  add_foreign_key "Bannerimage", "User", column: "created by"
  add_foreign_key "Category", "User", column: "created by"
  add_foreign_key "Country", "User", column: "created by"
  add_foreign_key "Custominterest", "User", column: "created by"
  add_foreign_key "IndexpageVideo", "User", column: "created by"
  add_foreign_key "Interest", "User", column: "created by"
  add_foreign_key "Loacation", "User", column: "created by"
  add_foreign_key "Log", "User", column: "created by"
  ...
  add_foreign_key "Order", "User", column: "created by"
  ...
  add_foreign_key "Orderitem", "User", column: "created by"
  add_foreign_key "Paymentmain", "Order", column: "fk_order1_custom_order1"
  add_foreign_key "Paymentmain", "User", column: "fk_user1_user"
  add_foreign_key "Paymentmain", "User", column: "created by"
  add_foreign_key "Reservation", "User", column: "created by"
  add_foreign_key "Reservationschedulebook", "Reservation", column: "fk_reservation_custom_reservation"
  add_foreign_key "Reservationschedulebook", "User", column: "created by"
  ...
  add_foreign_key "Reservationuserregist", "User", column: "created by"
  add_foreign_key "Reservationuserregistdetail", "User", column: "created by"
  add_foreign_key "Review", "User", column: "created by"
  ...
  add_foreign_key "Scheduleactivity", "User", column: "created by"
  add_foreign_key "Scheduleday", "User", column: "created by"
  ...
  add_foreign_key "Schedulepermission", "User", column: "created by"
  add_foreign_key "Scheduleprogram", "User", column: "created by"
  ...
  add_foreign_key "Scheduleuserregist", "User", column: "created by"
  add_foreign_key "Signuptmp", "User", column: "created by"
  add_foreign_key "Video", "User", column: "created by"
